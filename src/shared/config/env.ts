...
const ENV = {
  ...
  NEXT_PUBLIC_API_TRADE_EXECUTION_BASE_URL: process.env.NEXT_PUBLIC_API_TRADE_EXECUTION_BASE_URL,
...
export const CONFIG = {
  ...
  apiTradeExecutionBaseUrl: optional(ENV.NEXT_PUBLIC_API_TRADE_EXECUTION_BASE_URL),

...
import type { CreateClientVaultResponse, CreateClientVaultRequest, RegisterClientVaultResponse, UpdateDailyHarvestConfigRequest, UpdateDailyHarvestConfigResponse, UpdateRewardSwapConfigRequest, UpdateCompoundConfigRequest, UpdateCompoundConfigResponse, UpdateRewardSwapConfigResponse } from "@/core/domain/vault/types";
